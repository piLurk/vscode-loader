...
import {
  LoaderEvent,
  ILoaderEventRecorder,
  LoaderEventType,
  LoaderEventRecorder,
  NullLoaderEventRecorder,
} from "./loaderEvents";
import { Utilities } from "./utils";
import { globalVar, Environment } from "./env";
...
export class Module {
  ...
  private static _safeInvokeFunction(
    ...
    try {
      return {
        returnedValue: callback.apply(globalVar, args),
        producedError: null,
      };
    } catch (e) {
      return {
  ...
  private static _invokeFactory(
    ...
    return {
      returnedValue: callback.apply(globalVar, dependenciesValues),
      producedError: null,
    };
  }
...
export class ModuleManager {
  ...
  private _createRequire(moduleIdResolver: ModuleIdResolver): IRelativeRequire {
    ...
    (<any>result).__$__nodeRequire = globalVar.nodeRequire;
    return result;
  }
